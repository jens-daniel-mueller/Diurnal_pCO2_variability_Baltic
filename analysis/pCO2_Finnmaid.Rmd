...
The data file contains Finnmaid observations averaged for each crossing of subregions of the Baltic Sea.
The subregion "7. HGF" is selected, because this subregion is usually crossed in the morning (before arrival in Helsinki) and again in the evening of the same day (after departure from Helsinki), therefore allowing to test for daytime variability of CO~2~ observations.
...
knitr::include_graphics("docs/figure/Fig_4-4.tiff")

```

# Calculating daily amplitudes
...
ggplot(diurnal, aes(day, d_pCO2, fill=d_Tem_hour, size=d_time))+
  ...
  theme_bw()
#ggsave("HGF_diurnal_dpCO2.pdf", width = 297, height = 210, units = "mm", dpi=300)
...
ggplot(diurnal, aes(day, d_CT_hour, fill=d_Tem_hour, size=d_time))+
  ...
  theme_bw()
#ggsave("HGF_diurnal_dCT.pdf", width = 297, height = 210, units = "mm", dpi=300)
